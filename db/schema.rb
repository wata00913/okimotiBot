...
ActiveRecord::Schema[7.0].define(version: 2023_08_25_033330) do
  ...
  create_table "channel_members", force: :cascade do |t|
    ...
    t.index ["slack_account_id"], name: "index_channel_members_on_slack_account_id"
    t.index ["slack_channel_id"], name: "index_channel_members_on_slack_channel_id"
  end
